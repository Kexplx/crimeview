...
?>
    ...
    <body>
        ...
        <div style="margin: 50 auto; max-width: 500px; text-align: center;">
            ...
            <p>
                CrimeView displays criminal statistics for a route between two german cities.
                <br>
                To look up your own routes visit our main site <a href="/home">here</a>.
            </p>
            <hr>
            <?php if ($data["fail"]) : ?>
            ...
            <?php else : ?>
                ...
                <table class="table table-striped" style="font-size: 13px; color: rgb(75, 75, 75);">
                    ...
                    <tbody>
                        <?php foreach ($data["counties"] as $county) : ?>
                            <tr>
