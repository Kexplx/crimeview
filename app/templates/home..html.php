...
<head>
    ...
    <script type="text/javascript" src="assets/js/models/County.js"></script>
...
<body>
    ...
    <div class="heading">
        <img src="assets/images/icons8-film-noir-100(1).png" alt="">
        <h1>CrimeView</h1>
        <p>Submit your travel route below to get started.</p>
    </div>

    <form class="form-search " method="GET ">
        <input id="inputDeparture" required type="text " placeholder="Departure">
        <img src="assets/images/icons8-daten-in-beide-richtungen-48.png" title="Change" onclick="exchangeInputs()">
        <input id="inputDestination" required type="text " placeholder="Destination">
        <button type="button" onclick="changeRoute()" class="btn btn-outline-dark">View Crime</button>
    </form>
    ...
    <script type="text/javascript">
        ...
        function addCountiesToMap(counties, map) {
            counties.forEach(county => {
                L.geoJson(county.geoJson, {
                    style: polystyle(county.color)
                }).addTo(map);
            });
        }
        ...
        function changeRoute() {
            ...
            new L.Routing.control({
                waypoints: [
                    L.latLng(Math.random() + 49, 12.0974869),
                    L.latLng(Math.random() + 49, 11.003645)
                ],
            ...
            var counties = [
                new County({
                    ...
                    "properties": {
                        "name_2": "Neumarkt in der Oberpfalz",
                        "name_0": "Germany",
                        "name_1": "Bayern",
                        "type_2": "Landkreis",
                        "engtype_2": "District",
