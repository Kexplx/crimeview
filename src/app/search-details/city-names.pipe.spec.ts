...
it('should concat city names with "-" for type "Line"', () => {
...
it('should concat city names with "-" for type "Polygon"', () => {
  const cities: City[] = [
...
it('should postfix first city name with "(10km Radius)" for type "Line"', () => {
